...
import org.melonframework.mvc.annotation.RequestMapping;
import org.melonframework.mvc.annotation.RequestParam;
import org.melonframework.mvc.annotation.ResponseBody;
import org.melonframework.mvc.processor.RequestProcessor;
import org.melonframework.mvc.render.ResultRender;
import org.melonframework.mvc.render.impl.JsonResultRender;
import org.melonframework.mvc.render.impl.ResourceNotFoundResultRender;
import org.melonframework.mvc.render.impl.ViewResultRender;
import org.melonframework.mvc.type.ControllerMethod;
import org.melonframework.mvc.type.RequestPathInfo;
import org.melonframework.util.ConverterUtil;
...
public class ControllerRequestProcessor implements RequestProcessor {
                ...
                if (method.isAnnotationPresent(RequestMapping.class)) {
                    ...
                    if (this.pathControllerMethodMap.containsKey(requestPathInfo)) {
                        log.warn("duplicate url: {} registration, current class {} method{} will override the former one",
                                requestPathInfo.getHttpMethod(), requestMappingClass.getName(), method.getName());
                    }
    ...
    public boolean process(RequestProcessorChain requestProcessorChain) throws Exception {
        ...
        //2、解析请求参数，并传递给获取的ControllerMethod实例去执行
    ...
    private Object invokeControllerMethod(ControllerMethod controllerMethod, HttpServletRequest request) {
        ...
        //2、根据获取到的请求参数及其对应的值，以及controllerMethod里面的参数和类型的映射关系，去实例化出方法对应的参数
